...
function ProductSort({handleSortProduct }) {
  const handleSort =(e) => {
    let myParent ;
    let option;
  ...
  return (
    <div className="product-sorts">
      <div className="product-sort" onClick={handleSort}>
        ...
        <div className="product-sort__selection"  >
          Chọn Size Giày
          <AiOutlineCaretDown className="product-sort__icon-down" />
        </div>
        <ul className="product-sort__option" title="1">
...
43
      ...
      <div className="product-sort" onClick={handleSort}>
        ...
        <ul className="product-sort__option" title="2">
      ...
      <div className="product-sort" onClick={handleSort}>
        ...
        <ul className="product-sort__option" title="3">
            <li className="product-sort__option__item" title="Giá từ thấp đến cao">
                  Giá từ thấp đến cao
            </li>
...
Từ Z -> A
      ...
      <div className="product-sort">
        <button className="product-sort__search" onClick={handleSortProduct}>Tìm kiếm ngay</button>
      </div>
    </div>
  );
}
